...
export class Player{
    constructor(x, y, context, movementList){
        this.velocity = 5
        this.radius = 15
        this.x = x
        this.y = y
        ...
        this.movementList = {
            minX: movementList.minX + this.radius,
            maxX: movementList.maxX - this.radius,
            minY: movementList.minY + this.radius,
            maxY: movementList.maxY - this.radius   
        }
    ...
    checkPositionLimitAndUpdate(){
        if(this.y < this.movementList.minY) this.y = this.movementList.minY
        if(this.y > this.movementList.maxY) this.y = this.movementList.maxY
        if(this.x < this.movementList.minX) this.x = this.movementList.minX
        if(this.x > this.movementList.maxY) this.x = this.movementList.maxX
    }
}